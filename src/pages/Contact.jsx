    ...
    >
      ...
      <div className="flex-1">
        ...
        >
          ...
          <button 
            type="submit"
            className="mt-2 w-full px-6 py-3 rounded-xl bg-zinc-900 dark:bg-blue-600 text-white font-medium hover:bg-zinc-800 dark:hover:bg-blue-500 transition-colors flex items-center justify-center gap-2 group shadow-lg shadow-zinc-900/20 dark:shadow-black/40"
          >
            Send Message
